package Coupons.comp127graphics;
...
public class Path extends GraphicsObject implements Strokable, Fillable {
     ...
     */
    public static Path makeTriangle(int x0, int y0, int x1, int y1, int x2, int y2) {
        return new Path(
                new java.awt.Point(x0, y0),
     ...
     */
    public Path(List<java.awt.Point> points) {
        this(points, true);
    }
     ...
     */
    public Path(java.awt.Point... points) {
        this(List.of(points));
    }
     ...
     *  a polygon.
     */
    public Path(List<java.awt.Point> points, boolean closed) {
     ...
     */
    public void setVertices(List<java.awt.Point> points) {
     ...
     *  a polygon.
     */
    public void setVertices(List<java.awt.Point> points, boolean closed) {
        ...
        if(points.isEmpty()) {
            ...
            for (java.awt.Point point : points.subList(1, points.size())) {
    ...
    public Coupons.comp127graphics.Point getPosition() {
        return new Coupons.comp127graphics.Point(getX(), getY());
    }
